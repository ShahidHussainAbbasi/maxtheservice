package maxtheservice.devops.authservice.client;
...
import maxtheservice.devops.authservice.exc.ValidationException;
import com.fasterxml.jackson.databind.ObjectMapper;

import feign.Response;
import feign.codec.ErrorDecoder;
import io.micrometer.core.instrument.util.IOUtils;
import maxtheservice.devops.authservice.exc.GenericErrorResponse;
